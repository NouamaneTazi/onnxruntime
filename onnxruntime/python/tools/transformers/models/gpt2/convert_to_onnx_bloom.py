...
def parse_arguments(argv=None):
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        default=os.path.join(".", "ort_cache_models"),
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        default=os.path.join(".", "ort_onnx_models"),
...
def main(argv=None, experiment_name="", run_id=0, csv_filename="gpt2_parity_results.csv"):
    ...
    if args.tolerance == 0:
        ...
        args.tolerance = [DEFAULT_TOLERANCE[k] for k in DEFAULT_TOLERANCE.keys() if k.name == args.precision.name][0]
    ...
    if args.input_test_file:
        ...
        for _, line in enumerate(read_f):
            ...
            if model_class.__name__ == "BloomLMHeadModel_BeamSearchStep":
                has_position_ids = False
        ...
        model.config.n_embd = model.config.n_embed
